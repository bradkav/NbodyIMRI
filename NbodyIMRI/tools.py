...
def open_file_for_read_main(fileID):
    """
    Open the emain output file in order to be read ignoring other files starting with the same IDhash (taking care of the correct directory structure and file endings)
